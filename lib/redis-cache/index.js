...
const HashFetch = require('./hash-fetch')
...
class RedisCache {
  ...
  constructor(ioRedisOpts, opts, redlockOpts) {
    ...
    this._hashFetch = new HashFetch(this.redis, this.redlock, this._opts)
  }
  ...
  asHash(policy, loadFn, loadFnArgs) {
    return this._hashFetch.execute(policy, loadFn, loadFnArgs)
  }
}
